...
export const metadata: Metadata = {
  ...
  description:
    "Enjoy unlimited AI-generated text and images without ads on Cogify.Social, featuring models like Claude 3.5, O1-Preview, Gemini-2, and DALL-E 3..",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-62YCN954BN"
        ></script>

        <script id="google-analytics">
          {" "}
          {` window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-62YCN954BN'); `}
        </script>
        <link
          rel="shortcut icon"
          href="/logo.png"
        ...
        <meta
          name="description"
          content="Claude 3.5, O1-Preview, Gemini-2, DALL-E 3, GPT-Realtime, and more. Enjoy unlimited generations, including text and images, without ads"
        />
        <meta
          name="keywords"
