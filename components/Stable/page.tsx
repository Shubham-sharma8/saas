...
export const StableAI: React.FC = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      setPhotos([]);
      const response = await axios.post("/api/stable", {
  ...
  return (
    <div className="flex flex-col h-full">
      <Head>
        <title>Image Generation By Stable Diffusion </title>
        <meta
          name="description"
          content="Experience the latest AI image generation with Stable Diffusion, available for free."
        />
      </Head>
      <Heading
        ...
        icon={
          <img
            src="https://cdn.futurepedia.io/ee1c503ee8e96ba578b0b357c233eca97d07336f-400x400.jpg"
            alt="Stable Diffusion Icon"
