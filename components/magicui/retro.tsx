...
const WhatsAppIcon = (props: any) => (
  ...
  const Geminiicon = (props: any) => (
    ...
    <img src="https://www.gstatic.com/pantheon/images/aiplatform/model_garden/icons/icon-gemini.png" alt="Gemini Icon" className="w-full h-full object-contain" x="0px" y="0px" width="100" height="100" viewBox="0 0 256 256" {...props}>
</img> 
    )
...
<img src="https://www.gstatic.com/pantheon/images/aiplatform/model_garden/icons/icon-anthropic.png" alt="Anthropic Icon" x="0px" y="0px" width="100" height="100" viewBox="0 0 256 256" {...props}>
</img>      )
