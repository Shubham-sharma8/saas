...
export const ChatPerp: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <Heading
        title="Perpexility"
        description="Perpexility is a powerful AI model that can generate text based on input based on Llama-3.1-Sonar-Large-32k-Online."
        icon={<img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/perplexity-ai-icon.png" alt="Perpexility Icon" className="w-full h-full object-contain" />}
