export const fr = {
  ...
  header: {
    title: "À propos",
    about:
      "Discutez avec l'IA en temps réel en utilisant l'API Realtime d'OpenAI. Appuyez simplement sur le bouton et commencez à parler !",
    banner:
      "Ceci est actuellement une version bêta et peut contenir quelques erreurs !",
  ...
  tools: {
    availableTools: {
      ...
      copyFn: {
        description:
          'Dites "Copiez ça dans le presse-papier" pour le coller ailleurs.',
        name: "Copier Fn",
      },
      getTime: {
        description:
      ...
      launchWebsite: {
        description:
          '"Ouvrir [site web]" pour ouvrir un site dans un nouvel onglet.',
        name: "Ouvrir un site web",
      },
      partyMode: {
        description:
          'Dites "Activer le mode fête" pour une animation dynamique de confettis !',
        name: "Mode fête",
      },
      themeSwitcher: {
        description:
          'Dites "Changer l’arrière-plan", "Passer en mode sombre" ou "Passer en mode clair".',
        name: "Changer de thème",
      },
      scrapeWebsite: {
        name: "Scraper de site web",
        description:
          'Dites "Extraire le contenu de [URL du site web]" pour récupérer le contenu d’une page web.',
      },
    },
    clipboard: {
      description: "Vous pouvez maintenant le coller ailleurs.",
      success:
        "Texte copié dans le presse-papier. Demandez à l'utilisateur de le coller quelque part.",
  ...
  language: "Français",
  languagePrompt:
    "Parlez et répondez uniquement en français. Il est crucial que vous mainteniez vos réponses en français. Si l'utilisateur parle dans d'autres langues, vous devez tout de même répondre en français.",
};
