...
export function isProviderEnabled(providerId: string): boolean {
  switch (providerId) {
    ...
    case "mistral":
      return (
        !!process.env.AZURE_INFERENCE_ENDPOINT_MISTRAL &&
        !!process.env.AZURE_INFERENCE_CREDENTIAL_MISTRAL
      );
    case "cohere":
      return (
        !!process.env.AZURE_INFERENCE_ENDPOINT_COHERE &&
        !!process.env.AZURE_INFERENCE_CREDENTIAL_COHERE
      );
    case "groq":
